    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float4 _Property_B10DF0E5_Out_0 = _BaseColor;
                float _Property_60B7B8E_Out_0 = _Metallic;
                float _Property_E4BA2CC3_Out_0 = _Specular;
                surface.Albedo = (_Property_B10DF0E5_Out_0.xyz);
                surface.Normal = IN.TangentSpaceNormal;
                surface.Emission = IsGammaSpace() ? float3(0, 0, 0) : SRGBToLinear(float3(0, 0, 0));
                surface.Metallic = _Property_60B7B8E_Out_0;
                surface.Smoothness = _Property_E4BA2CC3_Out_0;
                surface.Occlusion = 1;
                surface.Alpha = 1;
